/**
 *@author Haley Jundzil
 *email: hjundzil@gmail.com
 *date: 5/14/22
 *purpose: Code-Along: Window Master
*/

package com.hjundzil.windowmaster;
...
public class WindowMaster {
    public static void main(String [] args) {
        ...
        System.out.println("Window height = " + stringHeight + " feet");
        System.out.println("Window width = " + stringWidth + " feet");
